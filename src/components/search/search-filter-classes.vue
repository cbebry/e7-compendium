<template>
    <div class="search-filter-classes">
        <b-form-group label="Class(s)">
            <b-form-checkbox-group buttons v-model="selectedclass">
                <b-form-checkbox
                ...
                >
                    <img
                    :src="renderSymbol(classOption.symbol)"
                    :alt="classOptions.text" />
                </b-form-checkbox>
    ...
    data() {
        return {
            ...
            classOptions: [
                ...
                { text: 'soulweaver', value: 'soulweaver', symbol: 'symbol/icon_class_soulweaver.png' }
            ]
        }
    },
    methods: {
